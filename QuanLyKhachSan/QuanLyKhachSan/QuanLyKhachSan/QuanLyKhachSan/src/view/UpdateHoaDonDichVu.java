...
public class UpdateHoaDonDichVu extends javax.swing.JDialog {

    /**
     * Creates new form UpdateHoaDonDichVu
     */
    private DefaultTableModel tblModel;
    DecimalFormat formatter = new DecimalFormat("###,###,###");
    private ArrayList<DichVu> allProduct;
    private HoaDonDichVu phieuxuat;
    private ArrayList<HoaDonPhong> CTPhieu;
    private ArrayList<HoaDonPhong> CTPhieuOld;
    private HoaDonDichVuForm parent;
    private static final ArrayList<KhachHang> arrNcc = KhachHangDAO.getInstance().selectAll();

//    public UpdateHoaDonDichVu(javax.swing.JInternalFrame parent, javax.swing.JFrame owner, boolean modal) throws UnsupportedLookAndFeelException {
//        super(owner, modal);
//        UIManager.setLookAndFeel(new FlatLightLaf());
//        initComponents();
//        setLocationRelativeTo(null);
//        // Lay thong tin 
//        //allProduct = DichVuDAO.getInstance().selectAllExist();
...
//        displayInfo();
//    }
    private UpdateHoaDonDichVu(JFrame jFrame, boolean b) {
        super(jFrame, b);
        initComponents();
        setLocationRelativeTo(null);
    }

    UpdateHoaDonDichVu(HoaDonDichVuForm aThis, JFrame jFrame, boolean rootPaneCheckingEnabled) {
...
//        txtNguoiTao.setText(TaiKhoanDAO.getInstance().selectById(phieuxuat.getNguoiTao()).getTaiKhoan());
//    }
...
//        return tt;
//    }
    public DichVu findMayTinh(String maMay) {
        for (var i : allProduct) {
            if (maMay.equals(i.getMaDichVu())) {
                return i;
            }
        }
        return null;
...
//    public HoaDonPhong findCTPhieu(String maMay) {
//        for (var i : CTPhieu) {
...
//    }
    private void loadDataToTableNhapHang() {
        try {
            ...
            for (int i = 0; i < CTPhieu.size(); i++) {
                tblNhapHangmd.addRow(new Object[]{ //     i + 1, CTPhieu.get(i).getMaMay(), findMayTinh(CTPhieu.get(i).getMaMay()).getTenMay(), CTPhieu.get(i).getSoLuong(), formatter.format(CTPhieu.get(i).getDonGia()) + "đ"
                });
            }
        } catch (Exception e) {
        }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Mã hóa đơn bán lẻ");
        ...
        jLabel3.setText("Người tạo hóa đơn");
        ...
        deleteProduct.setText("Xoá dịch vụ");
...
//                DichVuDAO.getInstance().updateSoLuong(ct.getMaMay(), DichVuDAO.getInstance().selectById(ct.getMaMay()).getSoLuong() + ct.getSoLuong());
...
//            ChiTiecHoaDonDichVu pn = new ChiTiecHoaDonDichVu(phieuxuat.getMaPhieu(), sqlTimestamp, txtNguoiTao.getText(), CTPhieu, tinhTongTien());
//            try {
...
//                    JOptionPane.showMessageDialog(this, "Số lượng không đủ !");
//                } else {
//                  //  HoaDonPhong mtl = findCTPhieu((String) tblSanPham.getValueAt(i_row, 0));
//                    if (mtl != null) {
...
//                        }
//                    } else {
//                     //   DichVu mt = SearchProduct.getInstance().searchId((String) tblSanPham.getValueAt(i_row, 0));
//                     //   HoaDonPhong ctp = new HoaDonPhong(phieuxuat.getMaPhieu(), mt.getMaMay(), soluong, mt.getGia());
//                      //  CTPhieu.add(ctp);
//                    }
//                    loadDataToTableNhapHang();
//                  //  textTongTien.setText(formatter.format(tinhTongTien()) + "đ");
...
//        }
    ...
    public static void main(String args[]) throws UnsupportedLookAndFeelException {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                UpdateHoaDonDichVu dialog = new UpdateHoaDonDichVu(new javax.swing.JFrame(), true);
