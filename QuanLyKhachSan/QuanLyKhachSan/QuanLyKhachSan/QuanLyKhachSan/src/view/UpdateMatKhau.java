...
public class UpdateMatKhau extends javax.swing.JDialog {

    /**
     * Creates new form AddAccount
     */
    private TaiKhoan accCur;

    public TaiKhoan getAccCur() {
        return accCur;
    }

    public void setAccCur(TaiKhoan accCur) {
        this.accCur = accCur;
    }

    public UpdateMatKhau(javax.swing.JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
    }

    public UpdateMatKhau(javax.swing.JFrame parent, boolean modal, TaiKhoan t) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        this.accCur = t;
        tenTaiKhoan.setText(this.accCur.getTenNV());
        email.setText(this.accCur.getSDT());
    }
    ...
    private void initComponents() {
        ...
        passAft.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                passAftActionPerformed(evt);
            }
        });
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (nameAccount.equals("") || emailAccount.equals("") || passwordAccount.equals("")) {
            ...
            if (BCrypt.checkpw(passwordAccount, accCur.getMatKhau())) {
                accCur.setTenNV(nameAccount);
                accCur.setSDT(emailAccount);
                TaiKhoanDAO.getInstance().update(accCur);
...
//                BCrypt.hashpw(txtpassword.getText(), BCrypt.gensalt(12))
    ...
    private void passAftActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_passAftActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_passAftActionPerformed
