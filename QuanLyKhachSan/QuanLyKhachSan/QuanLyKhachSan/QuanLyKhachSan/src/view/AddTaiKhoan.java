...
public class AddTaiKhoan extends javax.swing.JDialog {
    ...
    public AddTaiKhoan(javax.swing.JInternalFrame parent, javax.swing.JFrame owner, boolean modal) {
        super(owner, modal);
        initComponents();
    ...
    private AddTaiKhoan(JFrame jFrame, boolean b) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }
    ...
    private void initComponents() {
        ...
        vaitro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Chọn", "Nhân viên lễ tân" }));
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        if (fullName.equals("") || user.equals("") || password.equals("") || role.equals("") || sdt.equals("")) {
            JOptionPane.showMessageDialog(this, "Vui lòng nhập đầy đủ thông tin !", "Cảnh báo ", JOptionPane.WARNING_MESSAGE);
        } else {
            if (TaiKhoanDAO.getInstance().selectById(user) == null) {
                TaiKhoan acc = new TaiKhoan(fullName, user, password, role, 1, sdt); // Include sdt here
