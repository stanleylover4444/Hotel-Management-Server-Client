...
//    @JoinColumn(name = "employeeID")
    ...
    public BookRoom(String bookRoomID, String bookDate, String bookTime, String checkInDate, String checkInTime, Customer customer, Room room, String status) {
...
//    }
    ...
    public String toString() {
        return "BookRoom{" + "bookRoomID=" + bookRoomID + ", bookDate=" + bookDate + ", bookTime=" + bookTime + ", checkInDate=" + checkInDate + ", checkInTime=" + checkInTime + ", customer=" + customer + ", room=" + room + ", status=" + status + '}';
    }
